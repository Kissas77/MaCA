...
class GlobalVar:
    ...
    reward_radar_fighter_detector = 0
    # fighter radar see a fighter
    reward_radar_fighter_fighter = 0  # todo before 10
    ...
    reward_strike_fighter_success = 100  # todo before 100
    ...
    reward_fighter_destroyed = -100  # todo before -100

    # A valid attack action
    reward_strike_act_valid = 0  # todo before 10
    # An invalid attack action
    reward_strike_act_invalid = 0  # todo before -10
