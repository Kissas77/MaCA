...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent1", type=str, default="maddispersedpg", help='agent 1 name, only name, not path')
    ...
    parser.add_argument("--random_pos", default=True, action="store_true", help='if the initial positions are random or fix')
