...
class RLFighter:
    def __init__(
        ...
        if self.gpu_enable:
            ...
            self.target_net.load_state_dict(torch.load('model/simple/{}.pkl'.format(MODEL_NAME)))
        else:
            self.target_net.load_state_dict(
                torch.load('model/simple/{}.pkl'.format(MODEL_NAME), map_location=lambda storage, loc: storage))
